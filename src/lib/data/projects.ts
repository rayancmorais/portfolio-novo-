...
export const projects: Project[] = [
  {
    ...
    technologies: ['Next.js 15', 'Fastify', 'PostgreSQL', 'BullMQ', 'Redis', 'NextAuth v5', 'Vercel', 'Railway'],
  ...
  },
  {
    ...
    technologies: ['NestJS', 'RabbitMQ', 'Socket.io', 'Keycloak', 'Kong', 'Docker', 'GitHub Actions', 'PostgreSQL'],
  ...
  },
  {
    ...
    technologies: ['Go', 'Gin', 'MongoDB', 'AWS Lambda', 'Stripe', 'MercadoPago', 'Claude (Anthropic)', 'next-intl'],
